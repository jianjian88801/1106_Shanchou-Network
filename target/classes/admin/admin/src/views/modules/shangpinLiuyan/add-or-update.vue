    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="留言内容" prop="shangpinLiuyanText">
                        <el-input type="textarea"  :readonly="ro.shangpinLiuyanText" v-model="ruleForm.shangpinLiuyanText" placeholder="留言内容"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.shangpinLiuyanText" label="留言内容" prop="shangpinLiuyanText">
                            <span v-html="ruleForm.shangpinLiuyanText"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
    ...
    export default {
        ...
        created() {
            ...
            if (this.role != "管理员"){
                ...
                this.ro.shangpinLiuyanText = true;//留言内容
            }
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`shangpinLiuyan/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.shangpinLiuyanCrossAddOrUpdateFlag = false;
                                        this.parent.search();
