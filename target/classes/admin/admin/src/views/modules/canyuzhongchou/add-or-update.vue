    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='zhongchou'">
                    <el-form-item class="select" v-if="type!='info'"  label="众筹" prop="zhongchouId">
                        <el-select v-model="ruleForm.zhongchouId" :disabled="ro.zhongchouId" filterable placeholder="请选择众筹" @change="zhongchouChange">
                            <el-option
                                    v-for="(item,index) in zhongchouOptions"
                                    v-bind:key="item.id"
                                    :label="item.zhongchouName"
                                    :value="item.id">
                            </el-option>
                        </el-select>
                    </el-form-item>
                ...
                <el-col :span="12"  v-if="sessionTable !='zhongchou' ">
                    <el-form-item class="input" v-if="type!='info'"  label="众筹编号" prop="zhongchouUuidNumber">
                        <el-input v-model="zhongchouForm.zhongchouUuidNumber"
                                  placeholder="众筹编号" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12"  v-if="sessionTable !='zhongchou' ">
                    <el-form-item class="input" v-if="type!='info'"  label="众筹名称" prop="zhongchouName">
                        <el-input v-model="zhongchouForm.zhongchouName"
                                  placeholder="众筹名称" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12"  v-if="sessionTable !='zhongchou' ">
                    <el-form-item class="input" v-if="type!='info'"  label="众筹类型" prop="zhongchouValue">
                        <el-input v-model="zhongchouForm.zhongchouValue"
                                  placeholder="众筹类型" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12"  v-if="sessionTable !='zhongchou' ">
                    <el-form-item class="input" v-if="type!='info'"  label="已筹金额" prop="yichouMoney">
                        <el-input v-model="zhongchouForm.yichouMoney"
                                  placeholder="已筹金额" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12"  v-if="sessionTable !='zhongchou' ">
                    <el-form-item class="input" v-if="type!='info'"  label="众筹总额" prop="zhongchouMoney">
                        <el-input v-model="zhongchouForm.zhongchouMoney"
                                  placeholder="众筹总额" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
            ...
            <input id="zhongchouId" name="zhongchouId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="参与金额" prop="zizuMoney">
                       <el-input v-model="ruleForm.zizuMoney"
                                 placeholder="参与金额" clearable  :readonly="ro.zizuMoney"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="参与金额" prop="zizuMoney">
                           <el-input v-model="ruleForm.zizuMoney"
                                     placeholder="参与金额" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  class="input" label="参与时间" prop="jieshuTime">
                        <el-date-picker
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.jieshuTime" label="参与时间" prop="jieshuTime">
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   ...
                   zhongchouId: [
                              { required: true, message: '众筹不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   zizuMoney: [
                              { required: true, message: '参与金额不能为空', trigger: 'blur' },
        ...
        created() {
         ...
         this.$http({
             url: `zhongchou/page?page=1&limit=100`,
             method: "get"
         }).then(({ data }) => {
             if (data && data.code === 0) {
                this.zhongchouOptions = data.data.list;
            }
         });
        ...
        methods: {
            ...
            info(id) {
                let _this =this;
                _this.$http({
                    url: `canyuzhongchou/info/${id}`,
                    method: 'get'
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        _this.ruleForm = data.data;
                        _this.yonghuChange(data.data.yonghuId)
                        _this.zhongchouChange(data.data.zhongchouId)
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`canyuzhongchou/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.canyuzhongchouCrossAddOrUpdateFlag = false;
                                        this.parent.search();
