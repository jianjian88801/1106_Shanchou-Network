...
public class ZhongchouLiuyanView extends ZhongchouLiuyanEntity implements Serializable {
	...
	public ZhongchouLiuyanView() {

	}

	public ZhongchouLiuyanView(ZhongchouLiuyanEntity zhongchouLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, zhongchouLiuyanEntity);
