...
public class CanyuzhongchouView extends CanyuzhongchouEntity implements Serializable {
	...
	public CanyuzhongchouView() {

	}

	public CanyuzhongchouView(CanyuzhongchouEntity canyuzhongchouEntity) {
		try {
			BeanUtils.copyProperties(this, canyuzhongchouEntity);
